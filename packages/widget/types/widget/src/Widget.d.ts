...
export type IWidgetInit = import("../../core/src/interfaces").IWidgetInit;
export type ILinker = import("../../core/src/interfaces").ILinker;
export type IAttrs = import("../../core/src/interfaces").IAttrs;
export type IEl = import("../../core/src/interfaces").IEl;
export type IElQuery = import("../../core/src/interfaces").IElQuery;
